...
% =========================================================================
dataStr = 'Von_Misses_truss_Criesfield.tcl'; %file (better if it includes full path)
...
%             [I,J,K,epsy,b]
        ...
        elseif(s(2).lower=='bilineartruss')
            eletag = str2num(s(3));
            I = str2num(s(4));
            J = str2num(s(5));
            s = str2double(s);
            ...
            epsy = s(9);
            b = s(10);
            Ele{eletag} = BilinearTruss(I,J,A,E,L0,epsy,b);
        elseif(s(2).lower=='bilinearcorotruss')
            eletag = str2num(s(3));
            I = str2num(s(4));
            J = str2num(s(5));
            s = str2double(s);
            ...
            epsy = s(9);
            b = s(10);
            Ele{eletag} = BilinearCoroTruss(I,J,A,E,L0,epsy,b);
        elseif(s(2).lower=='corotruss')
            eletag = str2num(s(3));
            I = str2num(s(4));
            J = str2num(s(5));
            s = str2double(s);
            ...
            epsy = s(9);
            b = s(10);
            Ele{eletag} = CoroTruss(I,J,A,E,L0,epsy,b);
        end
...
%%
% Define Static Load (User Input)
% =======================
Pext(4*3) = -2000;                % (Static Load)
r = 0*Pext;
...
%         Kt = tangGSM(Ele,nn,ne);
        ...
        fprintf(fileID,'%d %6.6f %6.6f %6.6f %6.6f %6.6f %6.6f %6.6f %6.6f\r\n',n,r(3*4-2),r(3*4),R_I(1),R_I(3),R_I(4),R_I(6),R_I(7),R_I(9));
        fclose(fileID);
    end
end
...
for i=1:ne
    ele_dof = [3*Ele{i}.I-2,3*Ele{i}.I-1,3*Ele{i}.I-0,3*Ele{i}.J-2,3*Ele{i}.J-1,3*Ele{i}.J-0];     
    RI  = getEndForce(Ele{i},Node,dr(ele_dof));
