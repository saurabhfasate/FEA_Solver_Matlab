classdef CoroTruss < handle
   ...
   methods
    function obj = CoroTruss(I,J,A,E,L0,epsy,b)
        obj.I = I;
        obj.J = J;
        obj.A = A;
        obj.E = E;
    ...
    function K = getElementGSM(obj,Node,dr)
        ...
        K = T*k*T.' + obj.f_trial/obj.L0*(z*z.');
    end
    function k = getLocalStiffnessMatrix(obj,Node,dr)
        [z,T,lf] = getTranformationMatrix(obj,Node);
        obj.f_trial = obj.f_trial +obj.K*(T.'*dr);
